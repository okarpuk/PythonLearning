...
generate_test_date = datetime.datetime.today() + datetime.timedelta(days=10)
input_test_date = generate_test_date.strftime("%m/%d/%Y")
date_field.send_keys(input_test_date)
date_field.send_keys(Keys.RETURN)
date_field.click()
print(input_test_date)
